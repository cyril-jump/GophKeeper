...
type Usecase interface {
	ProcessCreateNewTextData(ctx context.Context, userID string, data domain.TextData) error
}
...
func (r *Requests) CreateNewTextData(c echo.Context) error {
	...
	err := r.usecase.ProcessCreateNewTextData(c.Request().Context(), userID, inp)
