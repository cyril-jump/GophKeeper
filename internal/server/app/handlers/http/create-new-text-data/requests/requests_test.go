...
func (suite *Suite) Test_CreateNewTextData_200() {
	suite.e.POST("/", suite.reqs.CreateNewTextData)
	suite.db.EXPECT().CreateNewTextData(gomock.Any(), gomock.Any(), gomock.Any()).Return(nil)
...
func (suite *Suite) Test_CreateNewTextData_401() {
...
func (suite *Suite) Test_CreateNewTextData_500() {
	suite.e.POST("/", suite.reqs.CreateNewTextData)
	suite.db.EXPECT().CreateNewTextData(gomock.Any(), gomock.Any(), gomock.Any()).Return(domain.ErrInternal)
	data := domain.TextData{
		ID:       0,
		Text:     "111",
		Metadata: "222",
