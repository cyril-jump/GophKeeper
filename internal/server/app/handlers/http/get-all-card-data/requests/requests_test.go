...
func (suite *Suite) Test_GetAllCardData_200() {
	suite.e.GET("/", suite.reqs.GetAllCardData)
	suite.db.EXPECT().GetAllCardData(gomock.Any(), gomock.Any()).Return([]domain.CardData{}, nil)
...
func (suite *Suite) Test_GetAllCardData_204() {
	suite.e.GET("/", suite.reqs.GetAllCardData)
	suite.db.EXPECT().GetAllCardData(gomock.Any(), gomock.Any()).Return([]domain.CardData{}, domain.ErrDataNotFound)
...
func (suite *Suite) Test_GetAllCardData_401() {
	suite.e.Use(suite.mw.SessionWithCookies)
	suite.e.POST("/", suite.reqs.GetAllCardData)
	suite.db.EXPECT().GetAllCardData(gomock.Any(), gomock.Any()).Return([]domain.CardData{}, nil)
...
func (suite *Suite) Test_GetAllCardData_500() {
	suite.e.GET("/", suite.reqs.GetAllCardData)
	suite.db.EXPECT().GetAllCardData(gomock.Any(), gomock.Any()).Return([]domain.CardData{}, domain.ErrInternal)
