...
type Usecase interface {
	ProcessCreateNewCredData(ctx context.Context, userID string, data domain.CredData) error
}
...
func (r *Requests) CreateNewCredData(c echo.Context) error {
	...
	err := r.usecase.ProcessCreateNewCredData(c.Request().Context(), userID, inp)
