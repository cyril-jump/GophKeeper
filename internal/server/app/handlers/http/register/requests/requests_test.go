...
func (suite *Suite) Test_Register_200() {
	suite.e.POST("/", suite.reqs.Register)
	suite.db.EXPECT().Create(gomock.Any(), gomock.Any()).Return(nil)
	user := domain.User{
		ID:       "",
		Login:    "111",
		Password: "222",
...
func (suite *Suite) Test_Register_400() {
	suite.e.POST("/", suite.reqs.Register)
	suite.db.EXPECT().Create(gomock.Any(), gomock.Any()).Return(nil)
	user := domain.User{
		ID:       "",
...
func (suite *Suite) Test_Register_409() {
	suite.e.POST("/", suite.reqs.Register)
	suite.db.EXPECT().Create(gomock.Any(), gomock.Any()).Return(domain.ErrUserAlreadyExists)
	user := domain.User{
		ID:       "",
		Login:    "111",
		Password: "222",
...
func (suite *Suite) Test_Register_500() {
	suite.e.POST("/", suite.reqs.Register)
	suite.db.EXPECT().Create(gomock.Any(), gomock.Any()).Return(domain.ErrInternal)
	user := domain.User{
		ID:       "",
		Login:    "111",
		Password: "222",
