...
import (
	...
	"github.com/cyril-jump/gophkeeper/internal/server/app/handlers/http/get-all-cred-data/adapters"
	"github.com/cyril-jump/gophkeeper/internal/server/app/handlers/http/get-all-cred-data/usecase"
...
func (suite *Suite) Test_GetAllCredData_200() {
	suite.e.GET("/", suite.reqs.GetAllCredData)
	suite.db.EXPECT().GetAllCredData(gomock.Any(), gomock.Any()).Return([]domain.CredData{}, nil)
...
func (suite *Suite) Test_GetAllCredData_204() {
	suite.e.GET("/", suite.reqs.GetAllCredData)
	suite.db.EXPECT().GetAllCredData(gomock.Any(), gomock.Any()).Return([]domain.CredData{}, domain.ErrDataNotFound)
...
func (suite *Suite) Test_GetAllCredData_401() {
...
func (suite *Suite) Test_GetAllCredData_500() {
	suite.e.GET("/", suite.reqs.GetAllCredData)
	suite.db.EXPECT().GetAllCredData(gomock.Any(), gomock.Any()).Return([]domain.CredData{}, domain.ErrInternal)
