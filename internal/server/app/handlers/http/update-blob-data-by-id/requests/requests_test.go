...
import (
	...
	"github.com/cyril-jump/gophkeeper/internal/server/app/handlers/http/update-blob-data-by-id/adapters"
	"github.com/cyril-jump/gophkeeper/internal/server/app/handlers/http/update-blob-data-by-id/usecase"
...
func (suite *Suite) Test_UpdateBlobDataByID_200() {
	suite.e.PUT("/", suite.reqs.UpdateBlobDataByID)
	suite.db.EXPECT().UpdateBlobDataByID(gomock.Any(), gomock.Any(), gomock.Any()).Return(nil)

	data := domain.BlobData{
		ID:       0,
		Data:     []byte("111"),
		Metadata: "222",
	}
...
func (suite *Suite) Test_UpdateBlobataByID_400() {
	suite.e.PUT("/", suite.reqs.UpdateBlobDataByID)
	suite.db.EXPECT().UpdateBlobDataByID(gomock.Any(), gomock.Any(), gomock.Any()).Return(nil)
...
func (suite *Suite) Test_UpdateBlobDataByID_401() {
...
func (suite *Suite) Test_UpdateBlobDataByID_500() {
	suite.e.PUT("/", suite.reqs.UpdateBlobDataByID)
	suite.db.EXPECT().UpdateBlobDataByID(gomock.Any(), gomock.Any(), gomock.Any()).Return(domain.ErrInternal)
