...
type Usecase interface {
	ProcessUpdateCardDataByID(ctx context.Context, userID string, data domain.CardData) error
}
...
func (r *Requests) UpdateCardDataByID(c echo.Context) error {
	...
	err := r.usecase.ProcessUpdateCardDataByID(c.Request().Context(), userID, inp)
